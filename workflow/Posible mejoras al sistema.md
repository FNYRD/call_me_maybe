...
- [ ] **Cuestionario breve de repaso al iniciar cada sesión.** Nada más contextualizarse, y antes de abrir tema nuevo, el agente lanza un cuestionario corto (4–6 preguntas, una por mensaje) sobre lo aprendido y lo hecho en la sesión anterior. No es una evaluación: es reactivar el modelo mental antes de trabajar sobre él. Las preguntas salen del registro de la sesión anterior en `PROJECT.md` y del `NOTEBOOK.md`, y se hacen en orden de ejecución del programa. Lo que falle en el repaso se corrige en el momento y se anota; si un tema se cae de forma repetida, vuelve a estado `parcial` en el cuestionario de verificación. Complementa a la propuesta del arranque de sesión en tres pasos — al adoptarlas, fusionar el punto (c) de aquella con esta.
  *(call me maybe, 2026-08-10 — petición explícita del estudiante)*
